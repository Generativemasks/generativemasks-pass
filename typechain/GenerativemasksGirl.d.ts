...
interface GenerativemasksGirlInterface extends ethers.utils.Interface {
  functions: {
...
export class GenerativemasksGirl extends BaseContract {
  ...
  interface: GenerativemasksGirlInterface;
